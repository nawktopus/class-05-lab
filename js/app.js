...
function multiplyArray(multArr) { //eslint-disable-line
    let result = 0;
    result = multiply(testArray[0], testArray[1])[0];
    result = multiply(result,testArray[2])[0];
    //console.log(result);
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
    let result = 0;
    result = multiply(testDynamicArray[0],testDynamicArray[1])[0];
    result = multiply(result,testDynamicArray[2])[0];
    result = multiply(result,testDynamicArray[3])[0];
    result = multiply(result,testDynamicArray[4])[0];
    //console.log(result);

    return [result,'The numbers ' + testDynamicArray[0] + ',' + testDynamicArray[1] + ',' + testDynamicArray[2] +',' + testDynamicArray[3] + ',' + testDynamicArray[4] + ' have a product of ' + result + '.'];  
}
